...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 사용자 이름과 아이디를 가져옵니다.
    $userName = $_SESSION["userInfo"][0];
    $userId = $_SESSION["userInfo"][1];

    // 새 파일 이름을 다음 형식으로 생성합니다: "이름_아이디_날짜_시간.png"
    $newFileName = $userName . "_" . $userId . "_" . $currentDateTime . ".png";
    ...
    if (copy($graphFilePath, $savePath)) {
        ...
        $newCharacteristicsFilePath = "C:/Bitnami/wampstack-8.0.3-2/apache2/htdocs/myFistWeb/act2_upload_data/" . $userName . "_" . $userId . "_" . $currentDateTime . ".txt";
